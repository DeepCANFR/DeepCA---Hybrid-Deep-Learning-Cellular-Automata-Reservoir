...
neighboyrhood_template_1 = np.ones((11,11))
...
population_2 = fm.Soma_AS_with_projection_weights(membrane_decay = 0.9, treshold_decay = 0.8, membrane_treshold_resting_distance = 0.5, population_size_x = pop_x, population_size_y = pop_y, neighbourhood_template = neighboyrhood_template_2, weight_mean= 0.5, weight_SD = 0.3)
