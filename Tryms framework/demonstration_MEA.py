...
neuron_population_inhibitory = fm.Soma_AS_with_projection_weights(membrane_decay = 0.5, treshold_decay = 0.5, membrane_treshold_resting_distance = 1.0, population_size_x = population_x, population_size_y = population_y, neighbourhood_template = neighbourhood_template_inhibitory, weight_mean = 1.0, weight_SD = 0.3)
