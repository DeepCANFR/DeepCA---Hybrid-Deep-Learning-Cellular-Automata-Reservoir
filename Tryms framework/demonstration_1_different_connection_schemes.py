...
neighboyrhood_template_2 = np.ones((3,3))
neighboyrhood_template_2[0:2,:] = 0

neighboyrhood_template_3 = np.ones((7,7))
neighboyrhood_template_4 = np.ones((7,7))
neighboyrhood_template_4[0:4,0:4] = 0
neighboyrhood_template_4[5:,0:4] = 0
neighboyrhood_template_4[0:4,5:] = 0

population_1 = fm.Soma_AS_with_projection_weights(membrane_decay = 0.1, treshold_decay = 0.5, membrane_treshold_resting_distance = 0.5, population_size_x = pop_x, population_size_y = pop_y, neighbourhood_template = neighboyrhood_template_1, weight_mean= 0.5, weight_SD = 0.3)
population_2 = fm.Soma_AS_with_projection_weights(membrane_decay = 0.1, treshold_decay = 0.5, membrane_treshold_resting_distance = 0.5, population_size_x = pop_x, population_size_y = pop_y, neighbourhood_template = neighboyrhood_template_2, weight_mean= 0.5, weight_SD = 0.3)
population_3 = fm.Soma_AS_with_projection_weights(membrane_decay = 0.1, treshold_decay = 0.5, membrane_treshold_resting_distance = 0.5, population_size_x = pop_x, population_size_y = pop_y, neighbourhood_template = neighboyrhood_template_3, weight_mean= 0.5, weight_SD = 0.3)
population_4 = fm.Soma_AS_with_projection_weights(membrane_decay = 0.1, treshold_decay = 0.5, membrane_treshold_resting_distance = 0.5, population_size_x = pop_x, population_size_y = pop_y, neighbourhood_template = neighboyrhood_template_4, weight_mean= 0.5, weight_SD = 0.3)
