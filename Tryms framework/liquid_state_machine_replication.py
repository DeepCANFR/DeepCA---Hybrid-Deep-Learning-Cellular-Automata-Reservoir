...
IE_dendritic_arbor_parameters["projection_template"] = cp.ones((7,7))
...
P_delta_readout_parameters["learning_rate"] = 0.000025
...
neuron = [EE_dendritic_arbor, EE_delay_line, EE_axonal_terminal, excitatory_somas, inhibitory_somas, EI_dendritic_arbor, EI_axonal_terminal, EI_delay_line, IE_dendritic_arbor, IE_axonal_terminal, IE_delay_line, EE_dendritic_spine, EI_dendritic_spine, IE_dendritic_spine]
    ...
    for image_nr in range(len(image_test)):
        ...
        for image_time_step in range(timesteps_per_image):
            ...
            for component in neuron:
                ...
                #excitatory_somas.new_somatic_voltages += cp.random.uniform(0, 10, population_size)
