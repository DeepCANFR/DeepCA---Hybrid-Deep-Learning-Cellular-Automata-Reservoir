...
E_soma_parameters["membrane_time_constant"] = {"distribution":"uniform", "low":25, "high":35, "pos_neg_uniformity":"positive"} # ms
E_soma_parameters["absolute_refractory_period"] = 3 # ms
E_soma_parameters["threshold"] = {"distribution":"uniform", "low":13, "high":17, "pos_neg_uniformity":"positive"} # mv
E_soma_parameters["background_current"] = {"distribution":"uniform", "low":8, "high":10, "pos_neg_uniformity":"positive"} # nA
E_soma_parameters["input_resistance"] = {"distribution":"uniform", "low":0.5, "high":1.5, "pos_neg_uniformity":"positive"} # M_Ohm
...
E_soma_parameters["reset_voltage"] = {"distribution":"uniform", "low":8, "high":10, "pos_neg_uniformity":"positive"}# mv

# Inhibitory (I)
I_soma_parameters = {}
I_soma_parameters["type"] = rm.Circuit_Equation_Integrate_and_Fire_Soma
I_soma_parameters["population_size"] = population_size
I_soma_parameters["membrane_time_constant"] = {"distribution":"uniform", "low":25, "high":35, "pos_neg_uniformity":"positive"} # ms
I_soma_parameters["absolute_refractory_period"] = 2 # ms
I_soma_parameters["threshold"] = {"distribution":"uniform", "low":13, "high":17, "pos_neg_uniformity":"positive"} # mv
I_soma_parameters["background_current"] = {"distribution":"uniform", "low":8, "high":10, "pos_neg_uniformity":"positive"}  # nA
I_soma_parameters["input_resistance"] = {"distribution":"uniform", "low":0.5, "high":1.5, "pos_neg_uniformity":"positive"}  # M_Ohm
...
I_soma_parameters["reset_voltage"] = {"distribution":"uniform", "low":8, "high":10, "pos_neg_uniformity":"positive"}  # mv
...
import cloudpickle
with open('heterogenous_normal_Circuit_equation_5p5_reset_treshold_distance_somas_1.pkl', 'wb') as output:
