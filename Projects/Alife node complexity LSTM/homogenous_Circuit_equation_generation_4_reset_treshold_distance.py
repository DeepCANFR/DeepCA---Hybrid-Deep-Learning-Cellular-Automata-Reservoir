...
E_soma_parameters["background_current"] = 11 # nA
...
E_soma_parameters["reset_voltage"] = {"distribution":"homogenous", "value":11}# mv
...
I_soma_parameters["background_current"] =11 # nA
...
I_soma_parameters["reset_voltage"] = {"distribution":"homogenous", "value":11} # mv
...
import cloudpickle
with open('homogenous_Circuit_equation_4_reset_treshold_distance_somas_1.pkl', 'wb') as output:
