...
E_soma_parameters["background_current"] = 9.5 # nA
...
E_soma_parameters["reset_voltage"] = {"distribution":"homogenous", "value":9.5}# mv
...
I_soma_parameters["background_current"] =9.5 # nA
...
I_soma_parameters["reset_voltage"] = {"distribution":"homogenous", "value":9.5} # mv
...
import cloudpickle
with open('homogenous_Circuit_equation_5p5_reset_treshold_distance_somas_1.pkl', 'wb') as output:
