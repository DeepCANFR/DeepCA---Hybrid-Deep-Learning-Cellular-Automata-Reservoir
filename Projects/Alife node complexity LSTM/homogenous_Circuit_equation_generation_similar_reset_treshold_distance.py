...
E_soma_parameters["background_current"] = 10 # nA
...
E_soma_parameters["reset_voltage"] = {"distribution":"homogenous", "value":10}# mv
...
I_soma_parameters["background_current"] =10 # nA
...
I_soma_parameters["reset_voltage"] = {"distribution":"homogenous", "value":10} # mv
...
import cloudpickle
with open('homogenous_Circuit_equation_similar_reset_treshold_distance_somas_1.pkl', 'wb') as output:
