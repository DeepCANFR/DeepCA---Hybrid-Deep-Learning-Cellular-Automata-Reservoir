...
E_soma_parameters["background_current"] = 7 # nA
...
E_soma_parameters["reset_voltage"] = {"distribution":"homogenous", "value":7}# mv
...
I_soma_parameters["background_current"] =7 # nA
...
I_soma_parameters["reset_voltage"] = {"distribution":"homogenous", "value":7} # mv
...
import cloudpickle
with open('homogenous_Circuit_equation_8_reset_treshold_distance_somas_1.pkl', 'wb') as output:
