...
E_soma_parameters["reset_voltage"] = {"distribution":"homogenous", "value":13.5}# mv
...
I_soma_parameters["reset_voltage"] = {"distribution":"homogenous", "value":13.5} # mv
...
import cloudpickle
with open('homogenous_Circuit_equation_matched_treshold_distance_somas_1.pkl', 'wb') as output:
