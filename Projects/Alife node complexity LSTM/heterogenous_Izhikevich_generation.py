...
neurons = {}
neurons["E1_soma"] = rm.Izhikevich_Soma(E_1_soma_parameter_dict)
neurons["E2_soma"] = rm.Izhikevich_Soma(E_2_soma_parameter_dict)
neurons["E3_soma"] = rm.Izhikevich_Soma(E_3_soma_parameter_dict)

neurons["I1_soma"] = rm.Izhikevich_Soma(I_1_soma_parameter_dict)
neurons["I2_soma"] = rm.Izhikevich_Soma(I_2_soma_parameter_dict)
neurons["I3_soma"] = rm.Izhikevich_Soma(I_3_soma_parameter_dict)
