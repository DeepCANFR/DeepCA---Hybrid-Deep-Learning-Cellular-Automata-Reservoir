...
E_soma_parameters["background_current"] = 12 # nA
...
E_soma_parameters["reset_voltage"] = {"distribution":"homogenous", "value":12}# mv
...
I_soma_parameters["background_current"] =12 # nA
...
I_soma_parameters["reset_voltage"] = {"distribution":"homogenous", "value":12} # mv
...
import cloudpickle
with open('homogenous_Circuit_equation_3_reset_treshold_distance_somas_1.pkl', 'wb') as output:
