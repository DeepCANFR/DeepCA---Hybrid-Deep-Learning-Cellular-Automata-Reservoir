...
if __name__ == "__main__":
    ...
    with Client(n_workers = 3) as client:
        graph = bs.DistributedGraph(client, {"IzhikevichNode":bs.IzhikevichNode, "DelayLineNode":bs.DelayLineNode, "ArborizerNode":bs.ArborizerNode})
        ...
        graph.save_memories("test_Arborizer_1")